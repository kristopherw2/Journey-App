...
docker buildx build --platform linux/amd64  -t ccanonizado/journey-backend-prod:$NEW_VERSION -f backend/Dockerfile ./backend --no-cache
docker push ccanonizado/journey-backend-prod:$NEW_VERSION