  ...
  return (
    ...
    >
      <center>
        <Container>
          <h1
            className="parks-title"
            style={{ textAlign: "center", maxfontSize: "2.5em" }}
          >
          ...
          <div className="parks-links">
            <Link to="/webcams" className="parks-link">
              <div
                className="parks-link-card"
                style={{
                  backgroundImage: "url('/explore.jpeg')",
            ...
            <Link to="/activities" className="parks-link">
              <div
                className="parks-link-card"
                style={{
                  backgroundImage: "url('/explore2.jpeg')",
            ...
            <Link to="/tours" className="parks-link">
              <div
                className="parks-link-card"
                style={{
                  backgroundImage: "url('/explore3.jpeg')",
            ...
            <Link to="/videos" className="parks-link">
              <div
                className="parks-link-card"
                style={{
                  backgroundImage: "url('/explore4.jpeg')",
            ...
            <Link to="/campgrounds" className="parks-link campgrounds-link">
              <div
                className="parks-link-card"
                style={{
                  backgroundImage: "url('/explore5.jpg')",
                  textAlign: "left",
            ...
            <Link to="/experiences" className="parks-link">
              <div
                className="parks-link-card"
                style={{
                  backgroundImage: "url('/explore6.jpg')",
                  textAlign: "left",
